...
initMu = array(c(Mu[1], Mu[1] + runif(1, min=-0.1, max=0.1), Mu[1] + runif(1, min=-0.1, max=0.1), Mu[1] + runif(1, min=-0.1, max=0.1), Mu[2], Mu[2] + runif(1, min=-0.1, max=0.1), Mu[2] + runif(1, min=-0.1, max=0.1), Mu[2] + runif(1, min=-0.1, max=0.1), Mu[3], Mu[3] + runif(1, min=-0.1, max=0.1), Mu[3] + runif(1, min=-0.1, max=0.1), Mu[3] + runif(1, min=-0.1, max=0.1), Mu[4], Mu[4] + runif(1, min=-0.1, max=0.1), Mu[4] + runif(1, min=-0.1, max=0.1), Mu[4] + runif(1, min=-0.1, max=0.1)) , dim = c(4, 4),dimnames = list(row.names,column.names))
initCov <- list('Cluster 1' = Cov[[1]], 'Cluster 2' = Cov[[1]], 'Cluster 3' = Cov[[1]], 'Cluster 4' = Cov[[1]])
initProbs = sort(runif(5, min=0.1, max=0.9))
...
png('D:/Projects/EM-algorithm/plots/em-mgmm-plot-mall-customers-example-general-4cols.png', width=1080, height=1080)

options(repr.plot.width = 5, repr.plot.height =5)
# Scatter plot of clusters
ggplot(data = MallCustomers, aes(x = MallCustomers[,2], y = MallCustomers[,3], color = as.factor(c(results$cluster, 1)))) +
  geom_point(size = 3) +
  geom_point(data = as.data.frame(results$mu), aes(x = results$mu[,2], y = results$mu[,3]), color = "black", size = 4) +
  labs(title = "Scatter Plot of Clusters and Centroids", x = colnames(MallCustomers)[2], y = colnames(MallCustomers)[3]) +
  theme(text = element_text(size = 15), aspect.ratio = 1)
